...
function Footer() {
  return (
    <footer className="bg-light border-top mb-3" >
      <div className="container " >
        <div className="row mt-5">
          <div className="col-3">
            ...
            />
            <p className="text-muted">© 2010 - 2026, Zerodha Broking Ltd. All rights reserved.</p>
            ...
            <hr />
            <div className="footer-socialMedia-icon mb-4 ">
            ...
            <div className="footer-socialMedia-icon">
                ...
                <img src="Media/images/appstoreBadge.svg" alt="googlePlayBadge"/>
            </div>
          </div>
      ...
      <div
        className="container text-muted mb-3 fw-semibold "
        style={{ fontSize: "14px" }}
      >
